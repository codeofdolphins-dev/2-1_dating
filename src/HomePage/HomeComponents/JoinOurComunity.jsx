...
const JoinOurComunity = () => {
    return (
        <>
            <div className='container-fluid' style={{ backgroundColor: "#2563eb" }}>
                <div className='container py-5'>
                    <div>
                     ...
                     <div className='d-flex justify-content-center gap-3 mt-5' >
                        <button className="btn text-primary  px-4 py-2 rounded-1" style={{backgroundColor: "#ffff"}}>Sign Up Now</button>
