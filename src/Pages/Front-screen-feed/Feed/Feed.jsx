...
const Feed = () => {
  ...
  const handleGeneralFilter = () => {
    ...
    if (ShowFriendsFilter) setShowFriendsFilter(!ShowFriendsFilter);
    console.log(showGeneralFilter);
  };

  const handleFriendFilter = () => {
    setShowFriendsFilter(!ShowFriendsFilter);
    if (showGeneralFilter) setShowGeneralFilter(!showGeneralFilter);
    console.log(showGeneralFilter);
  };
        ...
        >
          <div className="d-flex justify-content-between align-items-end flex-wrap">
            ...
            <div className="d-flex gap-3">
              <button
                className="btn btn-outline-lighttext text-primary border border-primary rounded-pill position-relative"
              ...
              <div
                className={`${
                  showGeneralFilter ? "d-flex" : "d-none"
                } end-0 top-25 p-3  position-absolute mt-5`}
              ...
              <button
                className="btn btn-outline-light border border-danger rounded-pill text-danger position-relative"
              ...
              <div
                className={`${
                  ShowFriendsFilter ? "d-flex" : "d-none"
                } end-0 top-25 p-3  position-absolute mt-5`}
