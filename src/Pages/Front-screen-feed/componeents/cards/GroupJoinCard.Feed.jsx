                        ...
                        >
                            ...
                            <div className="small">
                                ...
                                <p className="mb-3">
                                    ...
                                    years of age and over which is designed around the desires
                                    of its members. Your host and hostess Eric and Cynthia have
                                    over 40 years in the ENM Lifestyle. We are dedicated to ...{" "}
                                    <a href="#">More</a>
                                </p>
                            </div>
                            ...
                            <div className="d-flex justify-content-between align-items-center mt-3">
                                <div className="d-flex align-items-center justify-content-center gap-2 w-100">
                                    <button
                                        className="btn btn-secondary rounded-pill px-5 py-2 w-100 text-white"
                                        disabled
                                    >
                                        Pending
                                    </button>
