  ...
  <div className="mt-5 pt-2">
    ...
    <Accordion defaultActiveKey="0" alwaysOpen>
      ...
      <Accordion.Item eventKey="0" className="custom-accordion-item">
        <Accordion.Header className="accordion-white-btn">
          HELP DESK FAQ
        </Accordion.Header>
        <Accordion.Body>
          <Accordion defaultActiveKey="0" flush>
            <Accordion.Item eventKey="0" className="custom-accordion-item">
              ...
              <Accordion.Body className="custom-accordion-body">
                When you set your account to Inactive, your profile will be
                hidden on 2+1. You will be invisible until you decide to log in
                again, at which time your profile will become Active and visible
                to others. <br /> <br />
                Time remaining on your current membership will run its course
                while your profile is set to inactive. If you have paid for your
                membership directly on the 2+1 website, then your recurring
                billing will be switched off.
              </Accordion.Body>
            </Accordion.Item>
