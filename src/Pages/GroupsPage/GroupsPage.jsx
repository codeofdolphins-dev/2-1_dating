...
const GroupsPage = () => {
    ...
    return (
        <>
            <GlobalPageWrapper>
                <FilterBar pageName={"Groups"} navigationPageName1={"My Groups"} navigationPageName2={"+Create A Group"} navigationToAnotherPage={handleNavigationPage1} navigationToAnotherPage2={handleNavigatePage2} filterName2={"Filter"} />
