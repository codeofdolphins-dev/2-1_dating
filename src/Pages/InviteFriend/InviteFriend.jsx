                    ...
                    <div className="row ">
                            <div className=" col-md-6 col-12 mb-4">
                                <div className="d-flex flex-column justify-content-center align-items-start gap-2" style={{ maxWidth: "350px", opacity: "0.75" }}>
                                    <h4>QR code</h4>
                                    <p className='' style={{ fontSize: "14px", textAlign: "justify" }}>Share the image of your personalized QR code below to invite your friends to join you on 2+1. Share it with your friends in person and on communication platforms like WhatsApp, Messenger, etc.</p>
                                    <img
                                        src={dummy_qrcode}
                                        alt="qr code"
                                        width={"200px"}
                            ...
                            <div className="col-md-6 col-12">
                                <div className="d-flex flex-column justify-align-content-between align-items-start gap-3" style={{ maxWidth: "350px", opacity: "0.75" }}>
                                    ...
                                    <p className='mb-0' style={{ fontSize: "14px", textAlign: "justify" }}>Share 2+1 with your friends on communication platforms like WhatsApp, Messenger, etc.</p>
                                    <img
                                        src={logo}
                                        alt="logo"
                                        width={"200px"}
