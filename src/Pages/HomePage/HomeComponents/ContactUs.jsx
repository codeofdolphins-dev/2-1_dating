...
const ContactUs = () => {
    return (
        <>
            <div className='container-fluid primary-background-color'  id='contact'>
                    ...
                    <div className="row  text-white  p-4 g-5">
                        ...
                        <div className="col-lg-6">
                            <form>
                                ...
                                <button type="submit" className="btn btn-primary w-100 primary-button">Send Message</button>
                            </form>
                        </div>

                        {/* Contact Info Section */}
                        <div className="col-lg-6 rounded-3 p-4" style={{ backgroundColor: "#0f113a",border: "1px solid #4b5563" }}>
