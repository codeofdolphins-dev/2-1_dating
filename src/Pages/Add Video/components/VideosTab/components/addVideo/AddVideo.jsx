      ...
      <Modal show={show} onHide={onClose} centered backdrop="static" size="lg">
        ...
        <Modal.Body>
          <p className="text-white small">
            Helpdesk will make the final decision on whether your videos will be approved and posted.
            Videos with children, animals, weapons, URLs, or drug paraphernalia will not be posted.
            Politically or religiously offensive videos or videos with contact details, external links,
            or referrals to other social networks will not be published either.
            Please make sure that all videos are yours. The maximum size per video is 250 MB and supported
            formats are 3gp, avi, wmv, mpeg, mov, and mp4.
          </p>
          ...
          >
            {file ? (
              ...
              <p className="mb-0 text-secondary">
                Click or Drop Video File here (max 250 MB)
              </p>
            )}
          </div>
